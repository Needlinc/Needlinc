...
class _HomePageState extends State<HomePage> {
  ...
  bool _isNewsMenuOpen = false;

  void _toggleNewsMenu() {
    setState(() {
      _isNewsMenuOpen = !_isNewsMenuOpen;
    });
  }
              ...
              child: Column(
                children: [
                  BackdropFilter(
                    ...
                    child: Container(
                      color: NeedlincColors.blue2.withOpacity(0.8),
                      width: 0.001,
                      height: 0.001,
                    ),
                  ),
                  Container(
                    ...
                    child: InkWell(onTap: _toggleNewsMenu ,
                      child: Container(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: _isNewsMenuOpen ? Colors.blue : NeedlincColors.blue1,
                          boxShadow: [
                            BoxShadow(
