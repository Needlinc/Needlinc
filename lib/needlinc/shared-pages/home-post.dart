                ...
                children: [
                  ...
                  imagePosts != null && imagePosts!.isNotEmpty
                    ...
                    children: imagePosts!.map((image) {
                      return Container(
                        width: MediaQuery.of(context).size.width * 0.3, // Image width
                        height: MediaQuery.of(context).size.width * 0.3, // Image height
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: const Text(
                                ...
                                style: TextStyle(fontSize: 12, color: NeedlincColors.black2),
                              ),
                            ),
                          ],
                        ),
                          ...
                          Wrap(
                            ...
                            children: occupations.map((category) {
                              return ChoiceChip(
                                ...
                                backgroundColor: selectedOccupations == category ? Colors.blue : null,
                      ...
                      onPressed: () async {
                        if (imagePosts == null && writeUp.text.isEmpty) {
                          ...
                          if (imagePosts != null) {
                            ...
                            notLoading = await UploadPost().homePagePostForImageAndWriteUp(
                                context, imagePosts!, writeUp.text, selectedOccupations);
                            Navigator.pop(context);
                          } else if (imagePosts != null && writeUp == null) {
                            notLoading = await UploadPost().homePagePostForImage(context, imagePosts!, selectedOccupations);
                            Navigator.pop(context);
                          } else if (imagePosts == null) {
